...
public class MoveChara {
    ...
    public boolean isMovable(int dx, int dy){
        if (mapData.getMap(posX+dx, posY+dy) == MapData.TYPE_WALL){
            return false;
        } else if (mapData.getMap(posX+dx, posY+dy) == MapData.TYPE_SPACE || mapData.getMap(posX+dx, posY+dy) == MapData.TYPE_KEY || mapData.getMap(posX+dx, posY+dy) == MapData.TYPE_HAMMER || mapData.getMap(posX+dx, posY+dy) == MapData.TYPE_POISON){
            return true;
        }
        return false;
    }
